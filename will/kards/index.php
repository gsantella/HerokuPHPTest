   		...
   		<div class="col-six tab-full">
   			...
   			<ul class="info-list">
   				<li>
   					...
   					<span>Wilson Osemwegie</span>
   				</li>
   				<li>
   					<strong>Birth Date:</strong>
   					<span>July 14, 1987</span>
   				</li>
   				<li>
   					<strong>Job:</strong>
   					<span>Student</span>
   				...
   				<li>
   					<strong>Email:</strong>
   					<span>wosemwegie88@southhills.edu</span>
   				</li>
...
<!--			  <div class="form-field">
   ...
   <footer>
     	<div class="row">
      	...
      	<div class="col-six tab-full">
	      	<div class="copyright">
		        	<span>&copy; Kards <?php echo date("Y");?></span> 
